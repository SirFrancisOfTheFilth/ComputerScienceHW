...
public class TempConverter
{
    public static void main(String[] args){
     ...
     boolean ifConvert = true; //allows for program to run indefinitely until it "breaks"
       ...
       while(ifConvert){
        ...
        if(scanInt == 1){ //converting from celsius to fahrenheit
            ...
            System.out.println( (((int)(100 * celsToFahr))/100.0) + " degrees fahrenheit. ");
           ...
           System.out.println( (((int)(100 * fahrToCels))/100.0) + " degrees celsius. ");
